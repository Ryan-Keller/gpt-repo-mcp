...
export const ACCESS_MATRIX: Record<AccessTier, string[]> = {
  ...
  bounded_packet_write: [
    ...
    "or appends one bounded checkpoint plus intervention receipt to an existing active Hermes transaction",
...
const TOOL_ACCESS_TIERS: Record<string, AccessTier> = {
  ...
  repo_codex_appserver_turn: "privileged_write",
  ...
  repo_hermes_intervene: "bounded_packet_write",
  repo_hermes_cancel: "privileged_write",
